    ...
    <main className='w-[390px] ml-auto mr-auto background-color'>
      <div className="ml-7 mr-7 flex flex-col justify-between h-screen">
        ...
        <h2 className="text-green text-base text-left">from anywhere in the world</h2>
            <input className='mt-24 white-input rounded-lg w-full h-10 pl-7' placeholder='Username' ref={nameRef}/>
            <input className='mt-4 white-input rounded-lg w-full h-10 pl-7' placeholder='Email' ref={emailRef}/>
        ...
        <div className="justify-center mt-auto mb-8">
            <button className="green-button rounded-lg w-full h-10" onClick={handleSignUp}>
